// USER 
export const SQL_CREATE_USER = 'INSERT INTO users (name, email, password) VALUES ($1, $2, $3) RETURNING id';
export const SQL_GET_USER = 'SELECT id, name, email, verified, created_at FROM users WHERE id = $1';
export const SQL_GET_USER_BY_EMAIL = 'SELECT id, password, verified FROM users WHERE email = $1';
...
export const SQL_SET_USER_AS_VERIFIED = 'UPDATE users SET verified = true WHERE id = $1';
export const SQL_SET_USER_PASSWORD = 'UPDATE users SET password = $2 WHERE id = $1';
...
// RESET PASSWORD 
export const SQL_CREATE_RESET_PASSWORD_TOKEN = 'INSERT INTO reset_password_tokens (token, user_id, email, expires_at) VALUES ($1, $2, CURRENT_TIESTAMP + $4::interval)';
